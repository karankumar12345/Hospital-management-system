...
const AddDoctorForm = () => {
  ...
  const fetchdoctor=async()=>{
    try {
        const response= await axios.get('https://hospital-management-system-1-lrix.onrender.com/doctor-single',{
            headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     ...
     const response=  await axios.patch('https://hospital-management-system-1-lrix.onrender.com/doctor-update', doctorData,{
        headers: {
