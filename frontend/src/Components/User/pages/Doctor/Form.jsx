...
const AppointmentForm = () => {
  ...
  const doctorDetails= async(id)=>{
    try{
      const {data}= await axios.get(`https://hospital-management-system-1-lrix.onrender.com/public/doctor/${id}`,{headers:{
        authorization:token
      }})
  ...
  const submithandler = async (event) => {
    ...
    try {
      const res = await axios.post(
        "https://hospital-management-system-1-lrix.onrender.com/patient/appointment",
        appointmentData,
        {
          headers: {
