...
const UserProfile = () => {
  ...
  const fetch_user = async () => {
    try {
      const response = await axios.get('https://hospital-management-system-1-lrix.onrender.com/userdetails', {
        headers: {
  ...
  const handleSaveClick = async () => {
    try {
      const response = await axios.put(
        'https://hospital-management-system-1-lrix.onrender.com/updatepatient',
        {
          username: userName,
          email: userEmail,
